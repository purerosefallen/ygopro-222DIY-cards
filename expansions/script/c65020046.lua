...
function c65020046.op(e,tp,eg,ep,ev,re,r,rp)
	if e:GetHandler():IsRelateToEffect(e) and Duel.GetLocationCount(tp,LOCATION_MZONE)>0 and e:GetHandler():IsCanBeSpecialSummoned(e,0,tp,false,false) then
...
function c65020046.reop(e,tp,eg,ep,ev,re,r,rp)
	if not Duel.IsExistingMatchingCard(c65020046.thfil,tp,LOCATION_DECK,0,1,nil) then return end
