...
function c13254063.initial_effect(c)
	...
	e4:SetCountLimit(1,13254063)
	e4:SetTarget(c13254063.destg)
	e4:SetOperation(c13254063.desop)
	c:RegisterEffect(e4)
	...
	e6:SetDescription(aux.Stringid(13254063,3))
	e6:SetCategory(CATEGORY_TODECK)
	e6:SetType(EFFECT_TYPE_IGNITION)
	e6:SetProperty(EFFECT_FLAG_CARD_TARGET)
	e6:SetRange(LOCATION_MZONE)
	e6:SetTarget(c13254063.pentg)
	e6:SetOperation(c13254063.penop)
	c:RegisterEffect(e6)
	--destroy
	...
	e8:SetCountLimit(1,23254063)
	e8:SetTarget(c13254063.destg1)
	e8:SetOperation(c13254063.desop1)
	c:RegisterEffect(e8)
...
function c13254063.pentg(e,tp,eg,ep,ev,re,r,rp,chk)
	...
	if chk==0 then return Duel.IsExistingTarget(c13254063.filter1,tp,LOCATION_GRAVE,0,1,nil) and (Duel.CheckLocation(tp,LOCATION_PZONE,0) or Duel.CheckLocation(tp,LOCATION_PZONE,1)) end
...
function c13254063.desop1(e,tp,eg,ep,ev,re,r,rp)
	local g=Duel.GetChainInfo(0,CHAININFO_TARGET_CARDS)
	local sg=g:Filter(Card.IsRelateToEffect,nil,e)
