...
function cm.setcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return re:IsActiveType(TYPE_MONSTER) and bit.band(loc,LOCATION_MZONE)~=0 and bit.extract(c:GetLinkedZone(),seq)~=0 and Duel.IsChainNegatable(ev) and rsphh.set(re:GetHandler())
end
