...
function c9980412.lcheck(g,lc)
	return g:IsExists(Card.IsLinkSetCard,1,nil,0x1bca) and g:IsExists(Card.IsLinkType,1,nil,TYPE_FUSION)
end
...
function c9980412.filter(c,e,tp)
	return c:IsSetCard(0x1bca) and c:IsType(TYPE_MONSTER) and c:IsCanBeSpecialSummoned(e,0,tp,false,false)
end
