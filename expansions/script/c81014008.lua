...
function c81014008.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	e3:SetCondition(c81014008.regcon)
	e3:SetOperation(c81014008.regop)
	...
	e4:SetCondition(c81014008.actcon)
	e4:SetValue(1)
	e4:SetReset(RESET_PHASE+PHASE_END)
	Duel.RegisterEffect(e4,tp)
end
function c81014008.regcon(e,tp,eg,ep,ev,re,r,rp)
	return ep==tp
end
function c81014008.regop(e,tp,eg,ep,ev,re,r,rp)
	Duel.RegisterFlagEffect(tp,81014908,RESET_PHASE+PHASE_END,0,1)
end
function c81014008.actcon(e)
	local tp=e:GetHandlerPlayer()
	return Duel.GetFlagEffect(tp,81014908)>0
end
