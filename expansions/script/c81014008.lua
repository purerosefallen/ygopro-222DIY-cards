...
function c81014008.initial_effect(c)
	...
	c:RegisterEffect(e2)
	Duel.AddCustomActivityCounter(81014008,ACTIVITY_ATTACK,c81014008.counterfilter)
end
function c81014008.counterfilter(c)
...
function c81014008.spcost(e,tp,eg,ep,ev,re,r,rp,chk)
	if chk==0 then return Duel.IsExistingMatchingCard(c81014008.costfilter,tp,LOCATION_HAND,0,1,nil) and Duel.GetCustomActivityCount(81014008,tp,ACTIVITY_ATTACK)==0 end
...
function c81014008.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	e2:SetTarget(c81014008.splimit)
