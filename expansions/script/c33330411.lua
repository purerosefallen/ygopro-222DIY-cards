...
function cm.initial_effect(c)
	local e1=rsnm.SummonFun(c,m,true)   
	local e2,e3=rsnm.FilpFun2(c,m,"atk",nil,rsop.target2(cm.fun,{cm.posfilter,"pos",LOCATION_MZONE },{cm.cfilter,nil,LOCATION_ONFIELD }),cm.op)
...
function cm.op(e,tp)
	...
	local e1=rsef.SV_UPDATE({e:GetHandler(),tc},"atk",ct*1000,nil,rsreset.est,"cd")
end
