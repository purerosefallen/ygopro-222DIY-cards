...
function c65020023.initial_effect(c)
	...
	e1:SetCountLimit(1,65020023+EFFECT_COUNT_CODE_OATH)
...
function c65020023.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	if tc:IsFaceup() and tc:IsRelateToEffect(e) then
		...
		tc:RegisterFlagEffect(0,RESET_EVENT+0x1fe0000+RESET_PHASE+PHASE_END,EFFECT_FLAG_CLIENT_HINT,1,0,aux.Stringid(65020023,0))
		Duel.BreakEffect()
