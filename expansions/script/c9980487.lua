...
function c9980487.initial_effect(c)
	...
	e1:SetTarget(aux.TargetBoolFunction(Card.IsSetCard,0x5bcb,0x4bcb))
	c:RegisterEffect(e1)
...
function c9980487.damcon(e,tp,eg,ep,ev,re,r,rp)
	...
	return ep~=tp and tc:IsSetCard(0x5bcb,0x4bcb) and tc:GetBattleTarget()~=nil and tc:GetBattleTarget():IsDefensePos()
end
